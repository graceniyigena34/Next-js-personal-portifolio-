              ...
              <div key={i} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {blog.tags.map((tag, j) => (
                      <span key={j} className="px-3 py-1 bg-gray-100 text-emerald-600 rounded-full text-sm">{tag}</span>
                    ))}
                  </div>
                  <a href="#" className="inline-block px-6 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition">
                    Read More
                  </a>
                </div>
              </div>
