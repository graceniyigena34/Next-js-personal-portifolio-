...
export default function Projects() {
  ...
  const projects = [
    ...
    { category: "web", title: "Financial Tracker", desc: "The Financial Tracker is a web application designed to help users manage personal finances efficiently. Users can track income and expenses, categorize transactions, and view summaries.", tech: ["Next.js", "TypeScript", "Tailwind", "Firebase"], link: "https://capstone-personal-financial-tracker-psi.vercel.app", image: "https://image.thum.io/get/width/800/crop/500/https://capstone-personal-financial-tracker-psi.vercel.app" },
    { category: "mobile", title: "Banking Mobile App", desc: "Mobile banking app where users can send money to the bank, withdraw funds, and chat live with bank support. Built as a cross-platform app for Android and iOS.", tech: ["React Native", "Expo", "Mobile UI", "Chat Support"], link: "#", gradient: "from-emerald-600 to-teal-700" },
